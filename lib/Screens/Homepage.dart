    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () async {
              Navigator.pushNamed(context, Routes.customerBooking);
            },
                                    ...
                                    InkWell(
                                      onTap: () {
                                        for (int i = 0;
                                          ...
                                          double long =
                                              double.parse(products['long']);
                                          double currentLat =
                                              _currentPosition!.latitude;
                                          double currentLong =
                                              _currentPosition!.longitude;
                                          const latlong2.Distance distance =
                                              latlong2.Distance();
                                          // km = 5
                                          final km = distance.as(
                                              latlong2.LengthUnit.Kilometer,
                                              latlong2.LatLng(lat, long),
                                              latlong2.LatLng(
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  double lat = double.parse(products['lat']);
                                  double long = double.parse(products['long']);
                                  double currentLat =
                                      _currentPosition!.latitude;
                                  double currentLong =
                                      _currentPosition!.longitude;
                                  ...
                                  final km = distance.as(
                                      latlong2.LengthUnit.Kilometer,
                                      latlong2.LatLng(lat, long),
                                      latlong2.LatLng(currentLat, currentLong));
